...
async def shake(droid, behavior = 'social'):
    ...
    if behavior == 'social':
        ...
        for i in ['1,2,3,4','1,2,3','1,2','1']:
            goal_shakes = len(i.split(','))
            droid.set_main_led(get_random_color())
            
            speak("Shake me with your left arm!" + i)
            when_collision_shake(droid, goal_shakes)
            
            
            
            speak("Shake me with your right arm!" + i)
            when_collision_shake(droid, goal_shakes)

            

            speak("Hold me and shake your left leg!" + i)
            when_collision_shake(droid, goal_shakes)

            speak("Hold me and shake your right leg!" + i)
            when_collision_shake(droid, goal_shakes)
            # time.sleep(0.1)
