...
async def main(behavior = 'physical'):
    activities = [0,1,2,3]
    keys = list(tips.keys())
    ...
    with SpheroEduAPI(toy) as droid:
        # speak("Testing physical shake activity.")
        # await shake(droid, behavior='physical')
        # speak("Test complete!")
...
if __name__ == "__main__":
    ...
    # main(behavior='physical')
    with SpheroEduAPI(toy) as sphero:
        try:
            asyncio.run(main(sphero, behavior='social'))
